...
\begin{itemize}
	\item \textbf{Modelo: } Los campos que tiene el modelo para cada palabra, son: la propia palabra, la probabilidad de indicar cada una de las emociones básicas y la neutralidad. Cada una de las palabras que tenemos recogidas se encapsulan en este modelo para ser almacenadas en el servidor.
...
Esta vista nos devuelve, mediante una petición \textbf{GET} al servidor, si tiene o no emoción consensuada y en caso de tenerla cuál.  Hablamos de emoción consensuada cuando el grado de certeza que se tiene de una de sus emociones es 1. 
...
Esta vista nos devuelve, mediante una petición \textbf{GET} al servidor, su emoción mayoritaria. Hablamos de emoción mayoritaria cuando el porcentaje de confianza de una emoción es mayor al del resto de emociones.
