...
\label{cap2:sec:scrum}
	...
	\begin{itemize}
		...
		\item \textbf{Sprint Planning}: Se trata de la planificación del sprint. Este evento consta de dos partes en las cuales participan el Product Owner y el equipo. En la primera parte el Product Owner presenta lo que quiere que se haga y resuelve dudas; en la segunda parte el equipo estima y deciden hasta donde van a llegar, para posteriormente crear el Sprint Backlog.
		\item \textbf{Daily Sprint Meeting}: Reunión diaria como máximo de quince minutos, de pie, donde cada componente del equipo informa sobre cómo va en sus tareas, lo que hizo el día anterior, lo que hará ese día y los problemas que ha encontrado o los que cree que se va a encontrar.
		...
		\item \textbf{Sprint Retrospective}: Reunión donde se habla de cómo ha funcionado el equipo en el sprint y qué cosas se pueden mejorar para el siguiente a nivel de proceso o metodología. En esta reunión participa todo el Scrum Team y el Scrum Master.
	\end{itemize}
