...
http://sesat.fdi.ucm.es/emociones/palabra/gradosEmo?palabra=\textit{palabra_buscada}

Cambiando \textit{palabra_buscada} por la palabra correspondiente. Por ejemplo: si quisiéramos buscar la palabra ``enfermedad" pondríamos lo siguiente:
...
http://sesat.fdi.ucm.es/emociones/palabra/mayoritariaEmo?palabra=\textit{palabra_buscada}

Cambiando \textit{palabra_buscada} por la palabra correspondiente. Por ejemplo: si quisiéramos buscar la palabra ``tormenta" pondríamos lo siguiente:
...
En caso de que la palabra buscada tenga una emoción mayoritaria, el resultado será como el que podemos ver en la figura \ref{fig:mayoritaria}, respuesta para la petición con ``abejas" como \textit{palabra_buscada}.
En el caso de que la palabra no se haya encontrado en el diccionario se devolverá una lista vacía de emociones ya que no hay y el grado cero, como podemos ver en la figura \ref{fig:mno}, respuesta para la petición con ``te" como \textit{palabra_buscada}.
...
\begin{table}[htbp]
		...
		\textit{Suma & 2,2 & 2,43 & 9,46 & 2,1 & 2,03} \\ \hline
		\textit{Palabras & \multicolumn{5}{|c|}{2}} \\ \hline
		\textbf{Valor final & 1,1 & 1,21 & 4,73 & 1,05 & 1,02} \\ \hline
		\end{tabular}
...
\begin{table}[htbp]
		...
		\textit{Suma & 5,57 & 3,4 & 5,86 & 3,16 & 2,53} \\ \hline
		\textit{Palabras & \multicolumn{5}{|c|}{2} }\\ \hline
		\textbf{Valor final & 2.78 & 1,7 & 2,93 & 1,58 & 1,26 }\\ \hline
		\end{tabular}
...
\figuta{Bitmap/Capitulo4/apiEj2}{width=0.6\textwidth}{fig:apiEj2}{Ejemplos mostrados en la api para el servicio de obtener los grados para las categorías emocionales de una palabra.}
