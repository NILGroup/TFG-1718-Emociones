...
\begin{table}[htbp]
		...
		\textit{Palabras} & \multicolumn{5}{|c|}{\textit{2}} \\ \hline
		\textbf{Valor final} & \textbf{1,1} & \textbf{1,21} & \textbf{4,73} & \textbf{1,05} & \textbf{1,02} \\ \hline
		\end{tabular}
...
\begin{table}[htbp]
		...
		\textit{Palabras} & \multicolumn{5}{|c|}{\textit{2}} \\ \hline
		\textbf{Valor final} & \textbf{2.78} & \textbf{1,7} & \textbf{2,93} & \textbf{1,58} & \textbf{1,26} \\ \hline
		\end{tabular}
