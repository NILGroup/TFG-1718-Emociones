...
En la seección 5.1, se contempla el problema del que partimos para realizar esta aplicación. En la sección 5.2, se presentará el proceso de diseño de la interfaz. Finalmente, en la sección 5.3, se detalla la implementación de la aplicación final.
\end{resumen}
