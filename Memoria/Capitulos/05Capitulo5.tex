...
\subsection{Pantalla principal}
La pantalla principal por defecto será muy similar a la propuesta en nuestro prototipo, mostrando la información por debajo del cuadro de texto. Para representar las emociones se mostrarán emoticonos coloreados. Los colores por defecto son los utilizados en la película "`Del revés"': amarillo para la alegría, azul para la tristeza, rojo para el enfado y morado para el miedo. Para la sorpresa utilizaremos el color naranja. El usuario podrá cambiar los colores si los que están por defecto no le resultan claros. También podrá cambiar cómo se muestran representadas las emociones, en vez de emoticonos puede elegir ver fotografías de personas o pictogramas de ARASAAC. 
