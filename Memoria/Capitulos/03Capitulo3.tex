...
Las categorías emocionales representan cada una de las emociones básicas de carácter universal. Existe una gran multitud de categorías emocionales, por lo que para reducir el número y hacer nuestro proyecto más fácil e intuitivo, nos centraremos en las conocidas como categorías emocionales básicas: \textit{miedo}, \textit{sorpresa}, \textit{alegría}, \textit{ira} y \textit{tristeza}, con el fin 
