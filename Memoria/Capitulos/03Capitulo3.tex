...
\subsection{Clairvoyance Affect Lexicon}
	...
	\begin{table}[htbp]
		...
		Descripcion & Nº palabra & Evaluación & Activación & Control & Frecuencia \\
		\hline 
		rapto & 621 & 1,37 & 1,97 & 1,69 & 4,29 \\ \hline
		\end{tabular}
...
En este caso la palabra \textbf{abandono} tiene los siguientes valores para las cinco categorías emocionales: 1,03 de alegría, 2,83 de ira, 4,30 de tristeza, 3,33 de miedo y 1,77 de asco. Como se puede apreciar los valores obtenidos en este diccionario para la palabra abandono son bastantes similares a los obtenidos por el diccionario de Hinojosa para la misma palabra.
